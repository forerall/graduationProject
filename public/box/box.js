...
function _check_form(width,height){
    ...
    $('.modal-form').find('.form-body-content').css('height',(height-40)+'px');
    $('.modal-form').css('margin-top','-'+(height*0.8)+'px');
...
function msg_box_mobile(msg, type, yes, no) {
    ...
    var modal_content_class = "position: fixed;background-color: #FFF;z-index: 30000000;max-width: 300px;width:80%;margin:0 auto 0;left:0;right:0;top:200px;display: none;border-radius: 5px;padding-top: 10px;box-shadow:1px 1px 1px #dddddd";
    var head_class = "";
    var content_class = "padding: 15px;line-height: 25px;";
