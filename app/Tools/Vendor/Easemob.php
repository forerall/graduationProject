...
class Easemob
{
    private $client_id = 'YXA6pdTHwA0REee7r0OLw7LkiQ';
    private $client_secret = 'YXA63ojh0pSa3-gNIxsBEniK20p7P9w';
    private $org_name = '1159160921115285';
    private $app_name = '20170320';
    private $url;
//------------------------------------------------------用户体系
    /**
     * 初始化参数
