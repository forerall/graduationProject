                ...
                <form class="form-horizontal" id="" action="" method="post">
                    ...
                    <div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-12 col-sm-1 no-padding-right" for="avatar">客服二维码</label>
                            <div class="col-xs-12 col-sm-11">
                                <div class="input-group">
                                    <div id="avatar" upload-name="kf" class="image-container"></div>
                                </div>
                            </div>
                        </div>
